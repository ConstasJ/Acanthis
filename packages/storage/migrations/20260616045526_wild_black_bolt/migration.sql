...
--> statement-breakpoint
CREATE TABLE `novel_cover_metadata` (
	`id` integer PRIMARY KEY AUTOINCREMENT,
	`hash` text NOT NULL,
	`content_type` text NOT NULL,
	`original_url` text NOT NULL UNIQUE,
	`novel_id` integer,
	CONSTRAINT `fk_novel_cover_metadata_novel_id_novels_id_fk` FOREIGN KEY (`novel_id`) REFERENCES `novels`(`id`) ON DELETE SET NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `volume_cover_metadata` (
	`id` integer PRIMARY KEY AUTOINCREMENT,
	`hash` text NOT NULL,
	`content_type` text NOT NULL,
	`original_url` text NOT NULL UNIQUE,
	`volume_id` integer,
	CONSTRAINT `fk_volume_cover_metadata_volume_id_volumes_id_fk` FOREIGN KEY (`volume_id`) REFERENCES `volumes`(`id`) ON DELETE SET NULL
);
--> statement-breakpoint
