...
- Updated dependencies [27ddae6]
  ...
  - @acanthis-dec/linovelib@1.0.3

## 1.0.2

### Patch Changes

- a63414f: 调整/linovelib/cover/novel 的行为，现在它可以直接从上游获取封面 URL 了
- Updated dependencies [3901772]
- Updated dependencies [51130dc]
  - @acanthis-dec/linovelib@1.0.2
